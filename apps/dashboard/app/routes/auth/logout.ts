import { destroyDashboardSession } from "~/lib/auth/dashboard-session.server";
import type { Route } from "./+types/logout";
import { redirect } from "react-router";
import { clearActiveDashboardOrganization } from "~/lib/workspace/dashboard-organization.server";
